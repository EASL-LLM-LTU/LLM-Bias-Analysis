...
# Per-item answer columns template (gender discipline)
ANSWER_TPL = {
    "gender_range": "Answer.Answer.gender_range{idx}",
}
...
def normalize_one_file(path: Path, discipline_label: str | None = None) -> pd.DataFrame:
    ...
    for _, row in df.iterrows():
        ...
        for idx in DEFAULT_ITEM_RANGE:
            ...
            answers = {k: ANSWER_TPL[k].format(idx=idx) for k in ANSWER_TPL}
            ...
            gender_range = safe_get(row, answers["gender_range"])
